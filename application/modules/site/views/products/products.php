		...
		$result .= '
								<div class="result-item format-standard">
                                	...
                                	<div class="result-item-in">
                                     	<h4 class="result-item-title"><a href="'.site_url().'spareparts/'.$product_web_name.'" title="'.$prod_name.'">'.$prod_name.'</a></h4>
                                		<div class="result-item-cont">
                                            ...
                                            <div class="result-item-block col2">
                                                ...
                                                <div class="result-item-action-buttons">
                                                    ...
                                                    <a href="'.site_url().'spareparts/'.$product_web_name.'" class="btn btn-default btn-sm">Enquire</a><br>
        	...
        	<div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    <!--<div class="btn-group pull-right results-sorter">
                        ...
                        <ul class="dropdown-menu" id="sort_products">
                          	<li><a href="price" method="DESC">Price (High to Low)</a></li>
                          	<li><a href="price" method="ASC">Price (Low to High)</a></li>
                          	<li><a href="created" method="DESC">Newness (Low to High)</a></li>
                          	<li><a href="created" method="ASC">Newness (High to Low)</a></li>
                        </ul>
                  	</div>
...
//Sort Products
/*$(document).on("click","ul#sort_products li a",function()
{
	var order_by = $(this).attr('href');
	var method = $(this).attr('method');
	
	window.location.href = '<?php echo site_url();?>spareparts/sort-by/'+order_by+'/'+method;
