	...
	*/
	function send_mandrill_mail($user_email, $user_name, $subject, $message, $sender_email = NULL, $shopping = NULL, $from = NULL, $button = NULL, $cc = NULL)
	{
		if(!isset($sender_email)){
			$sender_email = "info@autospares.co.ke";
		}
		if(!isset($shopping)){
			$shopping = "";
		}
		...
		'google_analytics_domains' => array('www.autospaces.co.ke'),
		'google_analytics_campaign' => 'alvaro@omnis.co.ke',
		'metadata' => array('website' => 'www.autospares.co.ke'),
