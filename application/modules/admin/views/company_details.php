        ...
        <!-- Jasny -->
        <link href="<?php echo base_url();?>assets/jasny/css/jasny-bootstrap.css" rel="stylesheet">		
        <script type="text/javascript" src="<?php echo base_url();?>assets/jasny/js/jasny-bootstrap.js"></script> 
          <div class="padd">
            <?php
