...
class Categories extends admin {
	...
	*/
	public function index() 
	{
		...
		{
			$data['content'] = '<a href="'.site_url().'admin/add-category" class="btn btn-success pull-right">Add Category</a>There are no categories';
		}
	...
	*
	*/
	public function edit_category($category_id, $page=0) 
	{
		//form validation rules
		$this->form_validation->set_rules('category_name', 'Category Name', 'required|xss_clean');
		$this->form_validation->set_rules('category_status', 'Category Status', 'required|xss_clean');
		...
		if ($this->form_validation->run())
		{
			...
			if($this->categories_model->update_category($file_name, $category_id))
			{
				...
				redirect('admin/all-categories/'.$page);
			}
	...
	*
	*/
	public function delete_category($category_id, $page=0)
	{
	...
	*
	*/
	public function activate_category($category_id, $page=0)
	{
	...
	*
	*/
	public function deactivate_category($category_id, $page=0)
	{
