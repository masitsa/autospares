...
class Users extends admin {
	...
	*/
	...
	{
		$where = 'users.activated = user_status.user_status_id';
		$table = 'users, user_status';
		//pagination
	...
	*/
	public function add_user() 
	{
		...
		$data['content'] = modules::run('admin/users/load_add_page');
		$this->load->view('templates/general_admin', $data);
	}
	...
	public function edit_user($user_id) 
	{
		...
		if ($this->form_validation->run())
		{
			...
			if($this->users_model->edit_user($user_id))
			{
				...
				$this->session->set_userdata('success_message', 'Update successfull');
				if(!empty($pwd_update))
				{
