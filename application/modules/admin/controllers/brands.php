...
class Brands extends admin {
	...
	*/
	public function index() 
	{
		...
		$config['base_url'] = base_url().'admin/all-brands';
		...
		{
			$data['content'] = '<a href="'.site_url().'admin/add-brand" class="btn btn-success pull-right">Add brand</a>There are no brands';
		}
	...
	public function add_brand() 
	{
		...
		if ($this->form_validation->run())
		{
			...
			if($this->brands_model->add_brand($file_name))
			{
				...
				redirect('admin/all-brands/'.$page);
			}
	...
	*
	*/
	public function edit_brand($brand_id, $page=0) 
	{
		//form validation rules
		$this->form_validation->set_rules('brand_name', 'brand Name', 'required|xss_clean');
		$this->form_validation->set_rules('brand_status', 'brand Status', 'required|xss_clean');
	...
	*
	*/
	public function delete_brand($brand_id, $page=0)
	{
		//delete brand image
		$query = $this->brands_model->get_brand($brand_id);
	...
	*
	*/
	public function activate_brand($brand_id, $page=0)
	{
	...
	*
	*/
	public function deactivate_brand($brand_id, $page=0)
	{
