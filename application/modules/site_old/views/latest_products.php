        ...
        <div class="col-md-12 no_padding">
            <div class="thumbnail">
                <div class="product_image">
                   <a href="#" data-toggle="modal" data-target="#modal2<?php echo $product_id;?>">
                ...
                <div class="caption">
                    <a class="product_name" href="#" data-toggle="modal" data-target="#modal2<?php echo $product_id;?>"> <?php echo $brand?> <?php echo $model?> <?php echo $category_name?></a>
                    
                    <h5>KES <?php echo $product_selling_price?></h5>
                    
                    <a class="btn btn-gray" href="#" data-toggle="modal" data-target="#modal2<?php echo $product_id;?>" style="background-color:#912A21; color:#fff; margin-top:16px; float:right; max-height:25px; padding-top:1px; width:80px;">View</a>
                </div>
            </div>
        </div>
         <!-- Modal -->
        <div class="modal fade" id="modal2<?php echo $product_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
