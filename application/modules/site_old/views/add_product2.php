...
<div class="home-page">
	...
	<div class="col-md-12 main_items">
		...
		echo form_open_multipart(site_url()."site/validate_product/", $attributes);
		?>
							...
							<div id="collapseOne" class="panel-collapse collapse">
								<div class="panel-body">
									<ul class="list-group">
										...
										<li class="list-group-item">You will be prompted to make a payment via MPesa of KES 250</li>
							...
							<div id="collapseTwo" class="panel-collapse collapse">
								<div class="panel-body">
									<ul class="list-group">
										...
										<li class="list-group-item">Enter an amount of KES 250</li>
